...
| [rsi-a0-a1-batch40-plan](rsi-a0-a1-batch40-plan.md) | **Plan (2026-09-10, not yet submitted):** in-harness A0 (ERDM v2) and A1 (RSI in the exact ERDM reduction) on the sst_pred contract at batch 40 with the A2 bundle recipe; upstream sst_pred ERDM training config decoded from its Lightning checkpoint; `rsi_a1.yaml` instantiation fix; open questions |
